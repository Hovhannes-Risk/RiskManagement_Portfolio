...
|---|---|---|---|---|---|---|---|
| 2026-04 | 1 | Integrity | Audit all 325 CL winning tickets | **MODIFY** | Tranche-based, stop-condition added | ~24 audit-hrs if tranches 1–2 clean | Operational scope tightened; finding unchanged |
| 2026-04 | 2 | Bot mitigation | Velocity cooldown + 5/day CAPTCHA threshold | **MODIFY** | Tiered by stake density; manual review of P15/P3/P18 first | Potential customer-loss event on 3 high-value accounts avoided | CAPTCHA threshold corrected from 5/day → 10/60min rolling |
| 2026-04 | 3 | Market margin | Football FTR margin +0.5%/+1.0% | **DEFER** | Re-evaluate next period | $80k weekly stake protected from premature change | One-period observation insufficient |
| 2026-04 | 4 | Market margin | CS2 IEM margin review | **REJECT** | No margin change | CS2 volume preserved | Inside CS2-specific variance band |
| 2026-04 | 5 | Watchlist | Passive monitoring of 174 low-vol winners | **ACCEPT** | Auto-re-surface at 50 bets added | — | Implementation note appended |
| 2026-04 | 6 | Investigation | Cluster routing to investigations | **ACCEPT (caveat)** | 1-hour investigation cap per cluster | Investigation team protected from absorbing speculative load | Cost-cap added |

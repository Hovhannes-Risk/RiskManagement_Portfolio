...
# Shared anonymized sample — one trading day, exactly what a daily report consumes.
# In production this points at the daily book export.
...
pdf_path = OUT_DIR / f"daily_risk_report_{report_date}.pdf"
